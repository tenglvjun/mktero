...
const MESSAGES = Object.freeze({
    [LANGUAGE_ENGLISH]: Object.freeze({
        ...
        'annotation.actions': 'PDF annotation actions',
        'annotation.changeColor': 'Change annotation color',
        'annotation.delete': 'Delete annotation',
        'annotation.actionFailed': 'The PDF annotation could not be updated.',
        'annotation.noteEditor': 'Edit PDF note',
        'annotation.noteInput': 'PDF note',
        'annotation.notePlaceholder': 'Add a note…',
        'annotation.cancelNote': 'Cancel',
        'annotation.saveNote': 'Save',
        'annotation.noteSaveFailed': 'The PDF note could not be saved.',
        ...
        'annotation.editNote': 'Edit PDF note',
        'annotation.page': 'Page {page}',
        'annotation.edit': 'Add or edit PDF note: {text}',
    ...
    [LANGUAGE_SIMPLIFIED_CHINESE]: Object.freeze({
        ...
        'table.preview': '表格预览',
        'figure.preview': '图片预览',
        'annotation.actions': 'PDF 标注操作',
        'annotation.changeColor': '更改标注颜色',
        'annotation.delete': '删除标注',
        'annotation.actionFailed': '无法更新 PDF 标注。',
        'annotation.noteEditor': '编辑 PDF 笔记',
        'annotation.noteInput': 'PDF 笔记',
        'annotation.notePlaceholder': '添加笔记…',
        'annotation.cancelNote': '取消',
        'annotation.saveNote': '保存',
        'annotation.noteSaveFailed': '无法保存 PDF 笔记。',
        ...
        'annotation.editNote': '编辑 PDF 笔记',
        'annotation.page': '第 {page} 页',
        'annotation.edit': '添加或编辑 PDF 笔记：{text}',
