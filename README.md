...
- 支持英文和简体中文界面；默认跟随 Zotero 的显示语言，也可在设置中单独指定。
...
| 设置 | 默认值 | 说明 |
| --- | --- | --- |
| Display language | 跟随 Zotero | 支持英文和简体中文；Zotero 使用其他语言时回退为英文 |
...
手动选择的界面语言会保存在当前 Zotero 配置文件中，并在下次启动时继续使用。
